  ...
  const columnas = [
    ...
    { key: "acciones", label: "Acciones", render: (_, fila) =>
      fila.estado !== "Devuelto" ? (
        <button className="rounded border px-3 py-1 text-xs hover:bg-slate-50 cursor-pointer" onClick={() => console.log("Devolver:", fila.id)}>
          Devolver
        </button>
        ...
        ">
          ...
          <div>
            ...
            <p className="
              ...
              ">Gestiona préstamos y devoluciones de videos.</p> 
          </div>
